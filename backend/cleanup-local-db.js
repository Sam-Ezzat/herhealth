// Cleanup script for LOCAL database
// Database: herhealth_clinic
// This deletes all lab_orders, imaging, and prescriptions records from local DB
...
async function cleanup() {
  console.log('==========================================');
  console.log('Cleanup: LOCAL Database (herhealth_clinic)');
  console.log('==========================================\n');
  ...
  try {
    ...
    console.log('🎉 You can now delete visits from local database without errors!\n');
